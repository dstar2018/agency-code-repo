...
ALTER TABLE tbl_client_note ADD COLUMN is_entry_dismissable	BOOLEAN;
...
ALTER TABLE tbl_client_note_log ADD COLUMN dismissed_by		INTEGER REFERENCES tbl_staff (staff_id);
...
ALTER TABLE tbl_client_note_log ADD 
